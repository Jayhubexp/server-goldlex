...
// --- MODIFIED: Only import sendEmail ---
...
router.post("/", validateCarForm, async (req, res, next) => {
	try {
		...
		// --- MODIFIED: Send email to the admin/goldlex email ---
		let emailResult = { skipped: true };
		const emailRecipient = process.env.NOTIFY_EMAIL; // Use the central notify email
		if (emailRecipient) {
			try {
